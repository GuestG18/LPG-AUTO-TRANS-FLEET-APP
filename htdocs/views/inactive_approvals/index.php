...
<div class="inactive-approvals-page">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Aprobari si istoric pentru utilizarea vehiculelor, soferilor sau reparatiilor si pentru modificarile de diurna din Dispecer curse.</p>
        </div>
            ...
            <form class="row g-3 align-items-end" method="get">
                ...
                <div class="col-12 col-md-6 col-xl-2">
                    ...
                    <select class="form-select" id="approval_resource_type" name="resource_type">
                        ...
                        <option value="diurna" <?= $selectedResourceType === 'diurna' ? 'selected' : '' ?>>Diurna</option>
                    </select>
                </div>
                <div class="col-12 col-md-6 col-xl-2">
